...
class lomba2 extends StatefulWidget {
  const lomba2({Key? key}) : super(key: key);

  @override
  _lomba2 createState() => _lomba2();
}

class _lomba2 extends State<lomba2> {
  int _count = 0;
              ...
              child: Column(
                ...
                children: [
                  const AssetImageWidget(
                    imagePath: 'assets/images/lomba2.jpeg',
                    width: 350,
                    height: 350,
                    fit: BoxFit.cover,
                  ),
