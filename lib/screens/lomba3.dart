...
class lomba3 extends StatefulWidget {
  const lomba3({Key? key}) : super(key: key);

  @override
  _lomba3 createState() => _lomba3();
}

class _lomba3 extends State<lomba3> {
  int _count = 0;
              ...
              child: Column(
                ...
                children: [
                  const AssetImageWidget(
                    imagePath: 'assets/images/lomba3.jpeg',
                    width: 350,
                    height: 350,
                    fit: BoxFit.cover,
                  ),
